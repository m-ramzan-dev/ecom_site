                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub ">
                            <a class="js-arrow" href="{{ url('admin/category') }}">
                                <i class="fas fa-desktop"></i>Manage Categories
                            </a>

                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="{{ url('admin/coupon') }}">
                                <i class="fas fa-desktop"></i>Manage Coupons
                            </a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="{{ url('admin/size') }}">
                                <i class="fas fa-desktop"></i>Manage Sizes
                            </a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="{{ url('admin/color') }}">
                                <i class="fas fa-desktop"></i>Manage Colors
                            </a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="{{ url('admin/product') }}">
                                <i class="fas fa-desktop"></i>Manage Products
                            </a>
                        </li>
                    </ul>
                </nav>
